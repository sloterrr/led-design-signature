  ...
  <table cellpadding="0" cellspacing="0" border="0" style="font-family: 'Poppins', Arial, Helvetica, sans-serif; max-width: 900px; border-collapse: collapse;">
    <tr>
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="margin-top: 15px; width: 150px;">
          <tr>
            <td align="center" style="font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 14px; color: #52B5EB; font-weight: 400; line-height: 1.4;">
              <a href="https://www.leddesign.pl" style="font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 14px; color: #52B5EB; text-decoration: none; border: none; outline: none;">www.led.design</a>
            </td>
          </tr>
        </table>
      </td>
      ...
      <td valign="top" style="padding-right: 25px;">
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="margin-top: 15px; width: 150px;">
          <tr>
            <td align="center" style="font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 14.7px; font-style: italic; font-weight: 500; color: #52B5EB; line-height: 1.4;">
                ...
                <tr>
                  ...
                  <td valign="middle">
                    <a href="tel:+48606108500"
                       style="font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 15px; color: #52B5EB; text-decoration: none; border: none; outline: none; line-height: 1.3;">
                      +48 606 108 500
                    </a>
                  </td>
                </tr>
